...
<li>Admin</li>
<li><a href="products">Product Details</a> 
 </li>
</ul>
...
<a  class="suc" href="<?php echo SITE_URL.'admin/activeDeactiveProduct';?>/<?php echo $result->product_id;?>/Active" title="Approved" >
<?php echo $result->Status;?></a>
<?php } else{?>
<a class='err' href="<?php echo SITE_URL.'admin/activeDeactiveProduct';?>/<?php echo $result->product_id;?>/deActive" title="Not Approved" >
<?php echo $result->Status;?></a>
<?php }?>
</div>
</td>
...
<a href="<?php echo SITE_URL.'admin/deleteProduct';?>/<?php echo $result->product_id ;?>" onclick="return confirm('Are you sure to delete ?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" rel=""><i class="fa fa-times"></i></a>
