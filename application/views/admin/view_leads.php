...
<li>Admin</li>
<li><a href="leads">Leads Details</a> 
 </li>
</ul>
...
<td><?php echo substr($result->requirment ,0,20);?>... 
 <a href="#leadModal" data-toggle="modal" title="read More" class="btn btn-xs btn-default viewReq" rel="<?php echo $result->lead_id;?>">Read More</a></td>
...
<a  class="suc" href="<?php echo SITE_URL.'admin/activeDeactiveLead';?>/<?php echo $result->lead_id;?>/Active" title="Approved" >
<?php echo $result->status;?></a>
<?php } else{?>
<a class='err' href="<?php echo SITE_URL.'admin/activeDeactiveLead';?>/<?php echo $result->lead_id;?>/deActive" title="Not Approved" >
<?php echo $result->status;?></a>
<?php }?>
</div>
</td>
...
<a href="<?php echo SITE_URL.'admin/deleteLead';?>/<?php echo $result->lead_id;?>" onclick="return confirm('Are you sure to delete ?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" rel=""><i class="fa fa-times"></i></a>
...
<div id="leadModal" class="modal" tabindex="-1" role="dialog" aria-hidden="true"></div>