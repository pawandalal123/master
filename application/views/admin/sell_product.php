...
<li>Admin</li>
<li><a href="selProducts">Sell Product Details</a> 
 </li>
</ul>
<div class="block full">
<div class="block-title">
<h2>List Of Selling Products&nbsp;
...
<td><?php echo $result->sellertype ;?></td>
...
<a  class="suc" href="<?php echo SITE_URL.'admin/activeDeactiveSelProduct';?>/<?php echo $result->product_id;?>/Active" title="Approved" >
<?php echo $result->status;?></a>
<?php } else{?>
<a class='err' href="<?php echo SITE_URL.'admin/activeDeactiveSelProduct';?>/<?php echo $result->product_id;?>/deActive" title="Not Approved" >
<?php echo $result->status;?></a>
<?php }?>
</div>
</td>
...
<a href="<?php echo SITE_URL.'admin/deleteSelProduct';?>/<?php echo $result->product_id ;?>" onclick="return confirm('Are you sure to delete ?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" rel=""><i class="fa fa-times"></i></a>
