...
<script>
	...
	togglehtml: ["prefix", "<img src='http://www.indiabiztrade.com/assets/img/list-arow1.png' style='width:16px; height:11px; margin:2px 0px 0px 0px; float:right;' /> ", "<img src='http://www.indiabiztrade.com/assets/img/list-arow1.png' style='width:16px; height:11px; margin:2px 0px 0px 0px; float:right;' /> "],
	animatespeed: "fast", 
