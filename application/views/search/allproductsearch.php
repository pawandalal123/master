<?php 
$searchOn=$Searchfeild;
$serchfeaild=str_replace('-',' ',$searchOn);
$searchList=$this->common->SearchallProductDetails($serchfeaild,1);
...
$(document).ready(function(){  
	 $(window).scroll(function(){
		...
		if($(window).scrollTop() +1 >= $(document).height() - WindowHeight){ /* check is that user scrolls down to the bottom of the page */
			...
			$.post(SITE_URL+'commonfunc/searchproductOnLodeall',{'LastId':LastId,'searchon':searchon},function(data,status)
		     {
				 $("#loader").html("");
					if(data)
					{
...
<div class="mainContainer">
    ...
    <!-- left sidebar end -->
        ...
        <!-- detail page start -->
            ...
            <ul class="clearfix">
            <li class="active"><a href="<?php echo SITE_URL ?>search/productsearch/<?php echo $searchOn;?>">Suppliers</a></li>
            <li><a href="<?php echo SITE_URL ?>search/LeadsSearch/<?php echo $searchOn;?>">Buy Leads</a></li>
