         ...
         <ul class="group" id="example-one">
		  ...
		  else
		  {
            ...
            <li class="buy"><a href="<?php echo SITE_URL;?>adds">Sell</a>
            	<ul class="hdr-drop-down gl pad hide_n fnt-sz10">
              <a href="<?php echo SITE_URL;?>postadd"><li>Sell Product Free</li></a>
             <!-- <a href="#"><li>Manage Sell Offer Alerts</li></a>-->
	...
	<li class="homecatalog">
     ...
     <?php
				 foreach ($userCategorySubCategory as $userCategorySubCategory){
					 ?>
	 <li class="maincat"><a href="<?php echo SITE_URL;?>buylead/allindex/<?php  echo $userCategorySubCategory['CategoryName'].'/'.$userCategorySubCategory['categoryId'];?>" class="gm-mc-nm"><?php  echo $userCategorySubCategory['CategoryName'];?></a>
		<div class="cataloglistexpand electronics">
        <h2><a href="<?php echo SITE_URL;?>lead/<?php  echo str_replace(' ','-',$userCategorySubCategory['CategoryNameUrl']).'/'.$userCategorySubCategory['categoryId'];
			...
			<div class="flt subcatwrapper col4bg">
				...
				<div class="col">
					    ...
					    ?> 
                         <li><a href="<?php echo SITE_URL;?>buylead/subcategory/<?php  echo str_replace(' ','-',$CategoryNameUrl).'/'.str_replace(' ','-',$subCategory->subcat_url).'/'.$categoryId.'/'.$subCategory->sub_cat_id;?>" class="gm-tc-nm maintainHover"><?php  echo ucwords($subCategory->subcategory);?></a> </li>
                        <?php 
						if($i  > 59){
							?>
