...
<div id="slider">
 <a href="#" class="control_next">>></a>
  ...
  <ul>
          <li><img src="http://www.alessioatzeni.com/CSS3-Cycle-Image-Slider/images/img_2.jpg" alt="Lions"/></li>
         ...
         <li style="background: #aaa;">SLIDE 7</li>
         <li style="background: #aaa;">SLIDE 8</li>
         <li style="background: #aaa;">SLIDE 9</li>
  </ul>  
</div>
