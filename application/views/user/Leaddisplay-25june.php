...
<div class="updated">
<p class="fl"><img src="<?php echo WEBROOT_PATH_IMAGES?>location.png" class="fl"><strong>Location:</strong><?php echo $CategoryData->state;?></p>
<p class="fr">Updated: <?php echo date("F j, Y",strtotime($CategoryData->date));?></p>
  ...
  ?>
				...
				<span class="small_txt">Receive response from genuine & pre-verified suppliers only</span></h3>
                 ...
                 <form id="enquiryform"  action="<?php $_SERVER['PHP_SELF'];?>" method="post">
