  ...
  generate_wysiwyg('textarea2');
	  ...
	  else
	  {
          ...
          <form name="form1" method="post" action="<?php echo SITE_URL?>user/ctalogFeaturesupdate" enctype="multipart/form-data">
            	<div class="profile_pic"><div class="con_pro_m">
<fieldset>
<div  id="imgstore"  style="background: url(<?php  if($Contentdata->display_image!='') { echo WEBROOT_PATH_sell.''.$Contentdata->display_image; } else
{
 ...
 ?>
        ...
        <?php 
			...
			?>
                 ...
                 <div class="clear"></div>
                    <label class="fnt-bold fnt-sz10">Product Description</label>
            < <textarea id="textarea<?php echo $Contentdata->feature_id?>" name="description" ></textarea>
<?php echo form_error('description');?>
