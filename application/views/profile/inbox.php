...
{ ?>
			<div name="#<?php echo $i;?>">
           		<div class="tab1">
                <?php 
				$condition="YEAR(LEFT(tbl_products_enqiry.DATE,10)) = '".$i."' and tbl_company_details.user_id='".$userId."' and tbl_products_enqiry.status in('Pending','sentreply')";
			  ...
			  {?>
                          <div class="listbox<?php echo $enquieryData->id;?>">
                            ...
                            <ul class="ullist3">
                                ...
                                <li class="sender"><?php echo ucwords ($enquieryData->name);?><?php $checkFor= array("enquiry_id"=>$enquieryData->id); $replyStatus=$this->common->checkreplyStatus($checkFor);  if($replyStatus >0){ echo '<span class="countmail">'.$replyStatus.'</span>';}?></li>
                              ...
                              <input name="submit" id="<?php echo $j;?>" value="Reply" class="replybtn2" type="submit" />
                            </div>                            <!-- show box -->
						...
						$replyId++;	} }
							?>
                                ...
                                <div class="sender_form">
                                   <form action="<?php echo SITE_URL;?>user/addreply" method="post" enctype="multipart/form-data">
                                	<div class="sender_box_email">To: <?php echo ucwords ($enquieryData->name);?>;<?php echo $enquieryData->email?></div>
                                    <div class="sender_box_textarea">
                                    <textarea name="messagereply" id="textarea" cols="45" rows="5"></textarea>
                                    <input type="hidden" name="enquiry_id" value="<?php echo $enquieryData->id;?>"/>
                                    <?php echo form_error('messagereply');?>
                                    </div>
                               <!--<div class="attach_fileds">
                              	<div class="attach_fileds1">
                                <input type="file" name="file" id="fileField" />
                                <a href="#"><img src="<?PHP echo WEBROOT_PATH_IMAGES; ?>close_btn.png" class="fr attach_close"></a>
                                </div>
                              </div>-->
                              <div class="sender_box_attach clearfix">
                                    	<input name="submit" value="Send Reply" class="btn btn-blue mt fl" type="submit" />
                                        <p class="fl attachlink"><a href="#" class="fl">Attach a file</a><span class="fl"> (Maximum 4 Attachments)</span></p>
                                <a href="#"><img src="<?PHP echo WEBROOT_PATH_IMAGES; ?>delete.png" class="fr mt"></a>
                                </div>
                                </form>
                                </div>
